...
namespace Segurplan.Migrations.SqlServer.Migrations
{
    ...
    [Migration("20200716111903_fixNToNOnRisksAndPreventiveMeasures")]
    partial class fixNToNOnRisksAndPreventiveMeasures
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Segurplan.DataAccessLayer.Database.DataTransferObjects.ChapterVersionInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Segurplan.DataAccessLayer.Database.RiskAndPreventiveMeasuresMeasures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Segurplan.DataAccessLayer.Database.DataTransferObjects.Chapter", b =>
                {
                    ...
                    b.HasOne("Segurplan.DataAccessLayer.Database.DataTransferObjects.ChapterVersionInfo", "IdVersionInfoNavigation")
                        .WithMany("Chapter")
                        .HasForeignKey("IdVersionInfo")
                        .OnDelete(DeleteBehavior.Cascade);
