...
namespace Segurplan.Core.Extensions.Comparers {
    public class PlanChapterComparer : IEqualityComparer<PlanChapter> {

        public bool Equals(PlanChapter a, PlanChapter b) => a.Id == b.Id;

        public int GetHashCode(PlanChapter ch) {
