    ...
    */
    ...
    value: function createTable(colCount, rowCount, options) {
      ...
      for (var idxCol = 0; idxCol < colCount; idxCol++) {
          tds.push('<td style="border: 1px solid black;">' + '<span>' + dom.blank + '</span>' + '</td>');
      }
      ...
      for (var idxRow = 0; idxRow < rowCount; idxRow++) {
        trs.push('<tr style="border: 1px solid black;">' + tdHTML + '</tr>');
      }

      trHTML = trs.join('');
        var $table = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<table style="border: 1px solid black;">' + trHTML + '</table>');
...
var ImageDialog_ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<div class="form-group note-form-group note-group-select-from-files d-flex justify-content-center align-items-center">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-form-label btn btn-primary btn-sm text-light" style=" width: 160px">' + this.lang.image.selectFromFiles + '</label>', '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input form-control-file note-form-control note-input" ', ' type="file" name="files" accept="image/*" multiple="multiple"/>', imageLimitation, '</div>', '<div class="form-group note-group-image-url">', /*'<label for="note-dialog-image-url-' + this.options.id + '" class="note-form-label">' + this.lang.image.url + '</label>', '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url form-control note-form-control note-input" type="text"/>',*/ '</div>'].join('');
      var buttonClass = 'btn btn-primary note-btn note-btn-primary note-image-btn';
      var footer = "<input type=\"button\" style=\"display:none\" href=\"#\" class=\"".concat(buttonClass, "\" value=\"").concat(this.lang.image.insert, "\" disabled>");
      this.$dialog = this.ui.dialog({
